...
# Load the data
anno_data <- read.table("/data/users/tschiller/annotation_try2/EDTA_annotation/assembly.fasta.mod.EDTA.raw/assembly.fasta.mod.LTR.intact.raw.gff3", header = F, sep = "\t")
head(anno_data)
# Get the classification table
classification <- fread("/data/users/tschiller/annotation_try2/EDTA_annotation/assembly.fasta.mod.EDTA.raw/assembly.fasta.mod.LTR.intact.raw.fa.anno.list")
