...
#SBATCH --output=/data/users/tschiller/annotation_course/logs/%j_output_AEDFilter.o
#SBATCH --error=/data/users/tschiller/annotation_course/logs/%j_error_AEDFilter.e
