...
gff_file <- "/data/users/tschiller/annotation_try2/outputs/edta/assembly.fasta.mod.EDTA.TEanno.gff3"
...
custom_ideogram <- read.table("/data/users/tschiller/assembly_course/assemblies/LJA/assembly.fasta.fai", header = FALSE, stringsAsFactors = FALSE)
...
setwd("/data/users/tschiller/annotation_try2/plots")
